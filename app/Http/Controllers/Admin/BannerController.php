    ...
    public function datatables($type)
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('photo', function(Banner $data) {
                                $photo = $data->photo ? url('images/banners/'.$data->photo):url('images/noimage.png');
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
            ...
            {              
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'/images/banners/'.$data->photo)) {
                        unlink(public_path().'/images/banners/'.$data->photo);
                    }
                }            
            $input['photo'] = $name;
            } 
