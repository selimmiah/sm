    ...
    public function __construct()
        ...
        if($user->services->count() > 0)
        {
            foreach ($user->services as $gal) {
                if (file_exists(public_path().'/images/services/'.$gal->photo)) {
                    unlink(public_path().'/images/services/'.$gal->photo);
                }
                $gal->delete();
            }
        }
...
// PRODUCT
            ...
            foreach ($user->products as $prod) {
                ...
                if (file_exists(public_path().'/images/products/'.$prod->photo)) {
                    unlink(public_path().'/images/products/'.$prod->photo);
                }
