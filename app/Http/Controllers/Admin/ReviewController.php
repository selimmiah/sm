    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('photo', function(Review $data) {
                                $photo = $data->photo ? url('images/reviews/'.$data->photo):url('images/noimage.png');
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
            ...
            {              
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'/images/reviews/'.$data->photo)) {
                        unlink(public_path().'/images/reviews/'.$data->photo);
                    }
                }            
            $input['photo'] = $name;
            } 
