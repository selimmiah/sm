    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('photo', function(Service $data) {
                                $photo = $data->photo ? url('images/services/'.$data->photo):url('images/noimage.png');
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
            ...
            {              
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'/images/services/'.$data->photo)) {
                        unlink(public_path().'/images/services/'.$data->photo);
                    }
                }            
            $input['photo'] = $name;
            } 
