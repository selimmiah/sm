...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
            if ($file = $request->file('photo'))
            {
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'/images/categories/'.$data->photo)) {
                        unlink(public_path().'/images/categories/'.$data->photo);
                    }
                }
            $input['photo'] = $name;
            }
    ...
    public function destroy($id)
    {
        ...
        if (file_exists(public_path().'/images/categories/'.$data->image)) {
            unlink(public_path().'/images/categories/'.$data->image);
        }
        $data->delete();
        //--- Redirect Section
        $msg = 'Data Deleted Successfully.';
