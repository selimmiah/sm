...
class CatalogController extends Controller
{
    ...
    private function  code_image()
    {
        ...
        $font = base_path().'/public/front/fonts/NotoSans-Bold.ttf';
        ...
        imagepng($image, base_path()."/public/images/capcha_code.png");
    }
...
//        $product->update();
    ...
    // -------------------------------- PRODUCT COMMENT SECTION ----------------------------------------
        ...
        public function comment(Request $request)
        {
            ...
            $data[0] = $comment->user->photo ? url('images/users/'.$comment->user->photo):url('images/noimage.png');
    ...
    // -------------------------------- PRODUCT REPLY SECTION ----------------------------------------
        ...
        public function reply(Request $request,$id)
        {
            ...
            $data[0] = $reply->user->photo ? url('images/users/'.$reply->user->photo):url('images/noimage.png');
