...
@foreach($productt->comments()->orderBy('created_at','desc')->get() as $comment)
  <li>
    <div class="single-comment comment-section">
      <div class="left-area">
        <img src="{{$comment->user->photo != null ? asset('images/users/'.$comment->user->photo) : asset('images/noimage.png')}}" alt="">
...
@if($comment->replies)
  @foreach($comment->replies as $reply)
    <div class="single-comment replay-review hidden">
      <div class="left-area">
        <img src="{{ $reply->user->photo != null ? asset('images/users/'.$reply->user->photo) : asset('images/noimage.png') }}" alt="">
