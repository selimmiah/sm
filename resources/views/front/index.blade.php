...
@section('content')
					...
					<div class="hero-area-slider">
						...
						<div class="intro-carousel">
							@foreach($sliders as $data)
								<div class="intro-content {{$data->position}}" style="background-image: url({{asset('images/sliders/'.$data->photo)}})">
									<div class="container">
										<div class="row">
											<div class="col-lg-12">
				...
				@foreach($categories->where('is_featured','=',1) as $cat)
					<div class="col-xl-2 col-lg-3 col-md-4 sc-common-padding">
						<a href="{{ route('front.category',$cat->slug) }}" class="single-category">
							...
							<div class="right">
								<img src="{{asset('images/categories/'.$cat->image) }}" alt="">
							</div>
						</a>
					</div>
				@endforeach
	...
	<section id="extraData">
		<div class="text-center">
			<img src="{{asset('images/'.$gs->loader)}}">
		</div>
	</section>
