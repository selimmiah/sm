					...
					<div class="col-lg-3 remove-padding d-none d-lg-block">
						<div class="aside">
							<a class="banner-effect mb-10" href="{{ $ps->best_seller_banner_link }}">
								<img src="{{asset('images/'.$ps->best_seller_banner)}}" alt="">
							</a>
							<a class="banner-effect" href="{{ $ps->best_seller_banner_link1 }}">
								<img src="{{asset('images/'.$ps->best_seller_banner1)}}" alt="">
							</a>
						</div>
					</div>
				</div>
							...
							<div class="col-lg-12 remove-padding">
								<div class="img">
									<a class="banner-effect" href="{{ $img->link }}">
										<img src="{{asset('images/banners/'.$img->photo)}}" alt="">
									</a>
								</div>
							</div>
						@endforeach
					...
					<div class="col-lg-3 remove-padding d-none d-lg-block">
						<div class="aside">
							<a class="banner-effect mb-10" href="{{ $ps->big_save_banner_link }}">
								<img src="{{asset('images/'.$ps->big_save_banner)}}" alt="">
							</a>
							<a class="banner-effect" href="{{ $ps->big_save_banner_link1 }}">
								<img src="{{asset('images/'.$ps->big_save_banner1)}}" alt="">
							</a>
						</div>
					</div>
				</div>
								...
								<div class="aside-review-slider">
									@foreach($reviews as $review)
										<div class="slide-item">
											<div class="top-area">
												<div class="left">
													<img src="{{ $review->photo ? asset('images/reviews/'.$review->photo) : asset('images/noimage.png') }}" alt="">
												</div>
												<div class="right">
													<div class="content">
						...
						@foreach(DB::table('blogs')->orderby('views','desc')->take(2)->get() as $blogg)
							...
							<div class="blog-box">
								<div class="blog-images">
									<div class="img">
										<img src="{{ $blogg->photo ? asset('images/blogs/'.$blogg->photo):asset('images/noimage.png') }}" class="img-fluid" alt="">
							...
							@foreach($partners as $data)
								<div class="item-slide">
									<a href="{{ $data->link }}" target="_blank">
										<img src="{{asset('images/partner/'.$data->photo)}}" alt="">
									</a>
								</div>
							@endforeach
						</div>
	...
	<!-- main -->
	<script src="{{asset('front/js/mainextra.js')}}"></script>