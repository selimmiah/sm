...
{{--														--------------------------------------------------------}}
										...
										<div class="order-area">
											...
											<div class="order-item">
												<div class="product-img">
													<div class="d-flex">
														<img src=" {{ asset('images/products/'.$product['item']['photo']) }}"
			...
			<div class="submit-loader">
				<img src="{{asset('images/loading_large.gif')}}" alt="">
			</div>
		            ...
		            <div class="total-price">
		              ...
		              <p>
						...
						<div class="cupon-box">
							...
							<div id="coupon-link">
							<img src="{{ asset('front/images/tag.png') }}">
							{{ $langg->lang132 }}
							</div>
...
@if($gs->is_capcha == 1)
                                    ...
                                    <ul class="captcha-area">
                                        <li>
                                            <p><img class="codeimg1" src="{{asset("images/capcha_code.png")}}" alt=""> <i class="fas fa-sync-alt pointer refresh_code "></i></p>
                                        </li>
                                    </ul>
