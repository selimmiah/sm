                                            ...
                                            <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="user-image">
                                                            ...
                                                            <img src="{{ $data->photo ? asset($data->photo):asset('images/'.$gs->user_image)}}" alt="No Image">
                                                            @else
                                                            <img src="{{ $data->photo ? asset('images/users/'.$data->photo):asset('images/'.$gs->user_image)}}" alt="No Image">
                                                            @endif
