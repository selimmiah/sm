						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <div class="img-upload">
						                                ...
						                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset($data->photo):asset('images/noimage.png') }});">
						                            	@else
						                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('images/users/'.$data->photo):asset('images/noimage.png') }});">
						                                @endif
						                                @if($data->is_provider != 1)
