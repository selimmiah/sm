                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('images/categories/'.$data->photo):asset('images/noimage.png') }});">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                              <div id="image-preview" class="img-preview" style="background: url({{ $data->image ? asset('images/categories/'.$data->image):asset('images/noimage.png') }});">
