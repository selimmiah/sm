...
@section('content')
          ...
          <div class="content-area">
            ...
            <div class="add-logo-area">
                ...
                <div class="col-xl-4 col-md-6">
                  ...
                  @include('includes.admin.form-both')  
                          <div class="currrent-logo">
                            <img src="{{ $gs->logo ? asset('images/'.$gs->logo):asset('images/noimage.png')}}" alt="">
                          </div>
                          <div class="set-logo">
              ...
              @include('includes.admin.form-both')  
                        <div class="currrent-logo">
                          <img src="{{ $gs->footer_logo ? asset('images/'.$gs->footer_logo):asset('images/noimage.png')}}" alt="">
                        </div>
                        <div class="set-logo">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box  bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="currrent-logo">
                            <img src="{{ $gs->invoice_logo ? asset('images/'.$gs->invoice_logo):asset('images/noimage.png')}}" alt="">
                          </div>
