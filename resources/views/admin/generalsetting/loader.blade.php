                    ...
                    <div class="special-box">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="currrent-logo">
                            ...
                            <img src="{{ $gs->loader ? asset('images/'.$gs->loader):asset('images/noimage.png')}}" alt="">
                          </div>
                          <div class="set-logo">
                            <h4 class="title">
                              {{ __('Set New Loader') }} :
                    ...
                    <div class="special-box">
                        ...
                        <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="currrent-logo">
                            ...
                            <img src="{{ $gs->admin_loader ? asset('images/'.$gs->admin_loader):asset('images/noimage.png')}}" alt="">
                          </div>
