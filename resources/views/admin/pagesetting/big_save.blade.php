                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview" style="background: url({{ $data->big_save_banner ? asset('images/'.$data->big_save_banner):asset('images/noimage.png') }});">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="big_save_banner_link" placeholder="{{ __('Link') }}" required="" value="{{$data->big_save_banner_link}}">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview" style="background: url({{ $data->big_save_banner1 ? asset('images/'.$data->big_save_banner1):asset('images/noimage.png') }});">
                                                <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
