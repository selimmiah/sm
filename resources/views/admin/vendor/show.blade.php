                                            ...
                                            <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="user-image">
                                                            ...
                                                            <img src="{{ $data->photo ? asset($data->photo):asset('images/noimage.png')}}" alt="No Image">
                                                            @else
                                                            <img src="{{ $data->photo ? asset('images/users/'.$data->photo):asset('images/noimage.png')}}" alt="{{ __("No Image") }}">
                                                            @endif
						  ...
						  if(data[0] == 0)
						  {
							...
							$('.selected-image .row').append('<div class="col-sm-6">'+
											'<div class="img gallery-img">'+
												'<a class="img-popup" href="'+'{{asset('images/attachments').'/'}}'+arr[k]+'">'+
												'<img  src="'+'{{asset('images/attachments').'/'}}'+arr[k]+'" alt="gallery image">'+
												'</a>'+
											'</div>'+
										  '</div>');
							  }                         
