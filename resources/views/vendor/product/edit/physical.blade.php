...
<link href="{{asset('vendor/css/product.css')}}" rel="stylesheet"/>
<link href="{{asset('admin//css/jquery.Jcrop.css')}}" rel="stylesheet"/>
<link href="{{asset('admin//css/Jcrop-style.css')}}" rel="stylesheet"/>
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="img-upload  custom-image-upload">
															<div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('images/products/'.$data->photo):asset('images/noimage.png') }});">
                      ...
                      if(data[0] == 0)
                      {
        				...
        				$('.selected-image .row').append('<div class="col-sm-6">'+
                                        '<div class="img gallery-img">'+
                                            ...
                                            '</span>'+
                                            '<a href="'+'{{asset('images/galleries').'/'}}'+arr[k]['photo']+'" target="_blank">'+
                                            '<img src="'+'{{asset('images/galleries').'/'}}'+arr[k]['photo']+'" alt="gallery image">'+
                                            '</a>'+
                                        '</div>'+
                                  	'</div>');
                          }
...
<script src="{{asset('admin//js/jquery.Jcrop.js')}}"></script>

<script src="{{asset('admin//js/jquery.SimpleCropper.js')}}"></script>
...
$('.cropme').simpleCropper();
  ...
  $(document).ready(function() {
    ...
    let html = `<img src="{{ empty($data->photo) ? asset('images/noimage.png') : filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo :asset('images/products/'.$data->photo) }}" alt="">`;
