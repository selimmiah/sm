					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">
								...
								<div class="gocover"
									style="background: url({{asset('images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);">
								</div>
											...
											<div class="col-lg-12">
												<div class="img-upload  custom-image-upload">
													<div id="image-preview" class="img-preview"
														style="background: url({{ $data->photo ? asset('images/products/'.$data->photo):asset('images/noimage.png') }});">
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		let html =
			`<img src="{{ empty($data->photo) ? asset('images/noimage.png') : filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo : asset('images/products/'.$data->photo) }}" alt="">`;
