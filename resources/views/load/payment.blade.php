...
@if($payment == 'stripe') 
                                ...
                                <script type="text/javascript" src="{{ asset('front/js/payvalid.js') }}"></script>
                                <script type="text/javascript" src="{{ asset('front/js/paymin.js') }}"></script>
                                <script type="text/javascript" src="https://js.stripe.com/v2/"></script>
                                <script type="text/javascript" src="{{ asset('front/js/payform.js') }}"></script>
