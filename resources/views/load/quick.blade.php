...
<div class="xzoom-container">
    <img class="quick-zoom" id="xzoom-magnific1" src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:asset('images/products/'.$product->photo)}}" xoriginal="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:asset('images/products/'.$product->photo)}}" />
    <div class="xzoom-thumbs">

      <div class="quick-all-slider">

          <a href="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:asset('images/products/'.$product->photo)}}">
        <img class="quick-zoom-gallery" width="80" src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:asset('images/products/'.$product->photo)}}" title="The description goes here">
          </a>
      ...
      @foreach($product->galleries as $gal)
        ...
        <img class="quick-zoom-gallery" width="80" src="{{asset('images/galleries/'.$gal->photo)}}" title="The description goes here">
          </a>
...
<script src="{{asset('front/js/quicksetup.js')}}"></script>
