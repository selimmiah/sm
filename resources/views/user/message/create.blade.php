                                ...
                                <div class="col-lg-12">
                                    <div class="reply-area">
                                        <div class="left">
                                            ...
                                            <img class="img-circle" src="{{ $message->conversation->sent->photo != null ? $message->conversation->sent->photo : asset('images/noimage.png') }}" alt="">
                                            @else 
                                            <img class="img-circle" src="{{ $message->conversation->sent->photo != null ? asset('images/users/'.$message->conversation->sent->photo) : asset('images/noimage.png') }}" alt="">
                                            @endif
                                ...
                                <div class="col-lg-12">
                                    <div class="reply-area">
                                        ...
                                        <div class="right">
                                            ...
                                            <img class="img-circle" src="{{ $message->conversation->recieved->photo != null ? $message->conversation->recieved->photo : asset('images/noimage.png') }}" alt="">
                                            @else 
                                            <img class="img-circle" src="{{ $message->conversation->recieved->photo != null ? asset('images/users/'.$message->conversation->recieved->photo) : asset('images/noimage.png') }}" alt="">
                                            @endif
