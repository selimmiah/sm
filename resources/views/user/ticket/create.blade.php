                                ...
                                <div class="col-lg-12">
                                    <div class="reply-area">
                                        ...
                                        <div class="right">
                                            ...
                                            <img class="img-circle" src="{{$message->conversation->user->photo != null ? $message->conversation->user->photo : asset('images/noimage.png')}}" alt="">
                                            @else 

                                            <img class="img-circle" src="{{$message->conversation->user->photo != null ? asset('images/users/'.$message->conversation->user->photo) : asset('images/noimage.png')}}" alt="">
                        ...
                        <div class="single-reply-area admin">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="reply-area">
                                        <div class="left">
                                            <img class="img-circle" src="{{ asset('images/admin.jpg')}}" alt="">
