                                                ...
                                                <form>
                                                    ...
                                                    <div class="row pb-5">
                                                        ...
                                                        <div class="col-lg-8 pt-2 pl-5">
                                                             <a href="{{ url('/').'/?reff='.$user->affilate_code}}" target="_blank"><img src="{{asset('images/'.$gs->affilate_banner)}}"></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8 pt-2">
                                                             <textarea id="affilate_html" class="input-field affilate" name="address" readonly="" row="5"><a href="{{ url('/').'/?reff='.$user->affilate_code}}" target="_blank"><img src="{{asset('images/'.$gs->affilate_banner)}}"></a></textarea>
                                                        </div>
                                                    </div>
