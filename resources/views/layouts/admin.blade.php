...
<head>
		...
		<link href="{{asset('admin/plugins/fullside-menu/waves.min.css')}}" rel="stylesheet" />

		<link href="{{asset('admin/css/plugin.css')}}" rel="stylesheet" />

		<link href="{{asset('admin/css/jquery.tagit.css')}}" rel="stylesheet" />
    	<link rel="stylesheet" href="{{ asset('admin/css/bootstrap-coloroicker.css') }}">
		<!-- Main Css -->
								...
								<ul class="list">
									...
									<li class="login-profile-area">
										<a class="dropdown-toggle-1" href="javascript:;">
											<div class="user-img">
												<img src="{{ Auth::guard('admin')->user()->photo ? asset('images/admins/'.Auth::guard('admin')->user()->photo ):asset('images/noimage.png') }}" alt="">
											</div>
										</a>
										<div class="dropdown-menu">
    ...
    <script src="{{asset('admin/js/vendors/vue.js')}}"></script>
		<script src="{{asset('admin/js/vendors/bootstrap.min.js')}}"></script>
		<script src="{{asset('admin/js/jqueryui.min.js')}}"></script>
		<!-- Fullside-menu Js-->
		<script src="{{asset('admin/plugins/fullside-menu/jquery.slimscroll.min.js')}}"></script>
		<script src="{{asset('admin/plugins/fullside-menu/waves.min.js')}}"></script>
