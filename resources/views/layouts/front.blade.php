...
<head>
    ...
    @elseif(isset($productt))
	    ...
	    <meta property="og:image" content="{{asset('images/thumbnails/'.$productt->thumbnail)}}" />
    ...
    @endif
	<!-- favicon -->
	<link rel="icon"  type="image/x-icon" href="{{asset('images/'.$gs->favicon)}}"/>


@if($langg->rtl == "1")

	<!-- stylesheet -->
	<link rel="stylesheet" href="{{asset('front/css/rtl/all.css')}}">

    <!--Updated CSS-->
 	<link rel="stylesheet" href="{{ asset('front/css/rtl/styles.php?color='.str_replace('#','',$gs->colors).'&amp;'.'header_color='.str_replace('#','',$gs->header_color).'&amp;'.'footer_color='.str_replace('#','',$gs->footer_color).'&amp;'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&amp;'.'menu_color='.str_replace('#','',$gs->menu_color).'&amp;'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">
...
@else
    ...
    <!--Updated CSS-->
 	<link rel="stylesheet" href="{{ asset('front/css/styles.php?color='.str_replace('#','',$gs->colors).'&amp;'.'header_color='.str_replace('#','',$gs->header_color).'&amp;'.'footer_color='.str_replace('#','',$gs->footer_color).'&amp;'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&amp;'.'menu_color='.str_replace('#','',$gs->menu_color).'&amp;'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">
...
@if($gs->is_loader == 1)
	<div class="preloader" id="preloader" style="background: url({{asset('images/'.$gs->loader)}}) no-repeat scroll center center #FFF;"></div>
@endif
...
@if(isset($visited))
    <div style="display:none">
        <img src="{{asset('images/'.$gs->popup_background)}}">
    </div>

    <!--  Starting of subscribe-pre-loader Area   -->
    <div class="subscribe-preloader-wrap" id="subscriptionForm" style="display: none;">
        <div class="subscribePreloader__thumb" style="background-image: url({{asset('images/'.$gs->popup_background)}});">
				...
				<div class="col-lg-2 col-sm-6 col-5 remove-padding">
					<div class="logo">
						<a href="{{ route('front.index') }}">
							<img src="{{asset('images/'.$gs->logo)}}" alt="">
						</a>
					</div>
				</div>
					...
					<div class="categories_menu">
						...
						<div class="categories_menu_inner">
							<ul>
								...
								@else
									<a href="{{ route('front.category',$category->slug) }}"><img src="{{ asset('images/categories/'.$category->photo) }}"> {{ $category->name }}</a>
					...
					<div class="footer-info-area">
						<div class="footer-logo">
							<a href="{{ route('front.index') }}" class="logo-link">
								<img src="{{asset('images/'.$gs->footer_logo)}}" alt="">
							</a>
						</div>
						<div class="text">
							<p>
					...
					<div class="footer-widget recent-post-widget">
						...
						<ul class="post-list">
							...
							<li>
								<div class="post">
								  <div class="post-img">
									<img style="width: 73px; height: 59px;" src="{{ asset('images/blogs/'.$blog->photo) }}" alt="">
								  </div>
										...
										<ul class="captcha-area">
											<li>
												<p><img class="codeimg1"
														src="{{asset("images/capcha_code.png")}}" alt=""> <i
...
{{--                                <li>--}}
{{--                                 	<p>--}}
{{--                                 		<img class="codeimg1" src="{{asset("images/capcha_code.png")}}" alt=""> <i class="fas fa-sync-alt pointer refresh_code "></i>--}}
{{--                                 	</p>--}}
		...
		<div class="modal-dialog quickview-modal modal-dialog-centered modal-lg" role="document">
		  <div class="modal-content">
			<div class="submit-loader">
				<img src="{{asset('images/'.$gs->loader)}}" alt="">
			</div>
			<div class="modal-header">
			  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
...
<script type="text/javascript">
  ...
  var langg    = {!! json_encode($langg) !!};
	...
	<script src="{{asset('front/js/vue.js')}}"></script>
	<script src="{{asset('front/jquery-ui/jquery-ui.min.js')}}"></script>
	<!-- popper -->
	...
	<script src="{{asset('front/js/jquery.hammer.min.js')}}"></script>
