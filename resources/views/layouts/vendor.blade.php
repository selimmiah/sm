...
<head>
		...
		<!-- Fontawesome -->
		<link rel="stylesheet" href="{{asset('vendor/css/fontawesome.css')}}">
		<!-- icofont -->
		<link rel="stylesheet" href="{{asset('vendor/css/icofont.min.css')}}">
		<!-- Sidemenu Css -->
		<link href="{{asset('admin/plugins/fullside-menu/css/dark-side-style.css')}}" rel="stylesheet" />
		<link href="{{asset('vendor/plugins/fullside-menu/waves.min.css')}}" rel="stylesheet" />

		<link href="{{asset('vendor/css/plugin.css')}}" rel="stylesheet" />

		<link href="{{asset('vendor/css/jquery.tagit.css')}}" rel="stylesheet" />
    	<link rel="stylesheet" href="{{ asset('vendor/css/bootstrap-coloroicker.css') }}">
		<!-- Main Css -->

	@if($langg->rtl == "1")

	<link href="{{asset('admin/css/rtl/style.css')}}" rel="stylesheet"/>
	<link href="{{asset('admin/css/rtl/custom.css')}}" rel="stylesheet"/>
	<link href="{{asset('admin/css/rtl/responsive.css')}}" rel="stylesheet" />
	...
	<body>
		<div class="page">
			<div class="page-main">
              ...
              <img src="{{ Auth::user()->photo ? asset(Auth::user()->photo):asset('images/noimage.png') }}" alt="">
              @else
              <img src="{{ Auth::user()->photo ? asset('images/users/'.Auth::user()->photo ):asset('images/noimage.png') }}" alt="">
              @endif
											</div>
										</a>
										<div class="dropdown-menu">
		...
		<!-- Dashboard Core -->
		<script src="{{asset('vendor/js/vendors/jquery-1.12.4.min.js')}}"></script>
		<script src="{{asset('vendor/js/vendors/bootstrap.min.js')}}"></script>
		<script src="{{asset('vendor/js/jqueryui.min.js')}}"></script>
		<!-- Fullside-menu Js-->
		<script src="{{asset('vendor/plugins/fullside-menu/jquery.slimscroll.min.js')}}"></script>
		<script src="{{asset('vendor/plugins/fullside-menu/waves.min.js')}}"></script>
